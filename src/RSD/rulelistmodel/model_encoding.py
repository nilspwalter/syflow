from ..data.attribute.attribute import Attribute
from ..mdl.mdl_base_codes import universal_code_integers_maximum, uniform_code, universal_code_integers
...
def compute_item_length(attribute: Attribute):
